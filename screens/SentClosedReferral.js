...
const SentClosedReferral = ({ navigation }) => {
      ...
      >
        <ContainerLoad visible={false} />
          <View 
            ...
            <ReferralShowScrollVertical items={referralsdata} filterSign="Done"  filterType="Sent" onPress={null} />
          </View>
      </SafeAreaView>
      <BottomNav />
    </KeyboardAvoidingView>
...
export default SentClosedReferral;
