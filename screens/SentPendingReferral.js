...
const SentPendingReferral = ({ navigation }) => {
      ...
      >
        <ContainerLoad visible={false} />
          <View 
            ...
            <ReferralShowScrollVertical items={referralsdata} filterSign="No"  filterType="Sent" onPress={null} />
          </View>
      </SafeAreaView>
      <BottomNav />
    </KeyboardAvoidingView>
...
export default SentPendingReferral;
