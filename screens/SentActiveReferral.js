...
const SentActiveReferral = ({ navigation }) => {
      ...
      >
        <ContainerLoad visible={false} />
          <View 
            ...
            <ReferralShowScrollVertical items={referralsdata} filterSign="Yes"  filterType="Sent" onPress={null} />
          </View>
      </SafeAreaView>
      <BottomNav />
    </KeyboardAvoidingView>
...
export default SentActiveReferral;
