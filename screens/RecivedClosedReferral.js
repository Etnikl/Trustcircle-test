...
const RecivedClosedReferral = ({ navigation }) => {
      ...
      >
        <ContainerLoad visible={false} />
          <View 
            ...
            <ReferralShowScrollVertical items={referralsdata} filterSign="Done"  filterType="Recived" onPress={null} />
          </View>
      </SafeAreaView>
      <BottomNav />
    </KeyboardAvoidingView>
...
export default RecivedClosedReferral;
