...
const RecivedPendingReferral = ({ navigation }) => {
      ...
      >
        <ContainerLoad visible={false} />
          <View 
            ...
            <ReferralShowScrollVertical items={referralsdata} filterSign="No"  filterType="Recived" onPress={null} />
          </View>
      </SafeAreaView>
      <BottomNav />
    </KeyboardAvoidingView>
...
export default RecivedPendingReferral;
